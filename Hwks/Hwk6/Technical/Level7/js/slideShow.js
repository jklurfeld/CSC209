...
function plusSlides(n) {
  let selectElement = document.getElementById("folderSelect");
  let selectedVal = selectElement.value;
  showSlides(slideIndex += n, selectedVal);
}
...
function showSlides(n, curFolder) {
  let i;
  let slides = document.getElementsByClassName(curFolder);
